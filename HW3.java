/* Sydney Davidson
   ...
   returns the four points of the rectangle,
   shrinks the rectangle down by 50%
   and then copies the new rectangle*/
...
public class HW3
{
   ...
   public static double getArea(Rectangle rect)
   {
       ...
       return rect.width*rect.height;  //Do not forget to change the return value
   }
   ...
   public static Rectangle copy_and_shrink(Rectangle original_rectangle)
   {
      ...
      return new_rectangle; //Do not forget to change the return value
   }
